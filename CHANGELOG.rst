...
**New features**
    ...
    * [:open-api-workflows:`188`] Add csv option to data dump script
    ...
    * [:open-product:`237`] Replace externe verwijzingen with urn/url fields.
        * Product Zaak, Taak, Document & ProducType ZaakType, VerzoekType & Proces now use urn/url fields. Mappings can be added in UrnMappingConfig.

     * [:open-product:`19`] Add ProductType object permissions to Producten API.

        * (non super) Users now require to have read or read-write permission to be able to create, update, read or delete Products
