...
from openproduct.accounts.tests.factories import OIDCClientFactory
from openproduct.utils.tests.keycloak import keycloak_login
...
class OIDCFlowTests(OIDCMixin, WebTest):
