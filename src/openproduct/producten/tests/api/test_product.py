...
class TestProduct(BaseApiTestCase):
    ...
    def test_required_fields(self):
        ...
        error = get_validation_errors(response, "producttype_uuid")
    ...
    def test_create_product_with_empty_eigenaar(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_400_BAD_REQUEST)
        error = get_validation_errors(response, "eigenaren.0.model_errors")
        self.assertIsNotNone(error)
        self.assertEqual(error["code"], "invalid")
        self.assertEqual(
            error["reason"],
...
class TestProductUrns(BaseApiTestCase):
    ...
    def test_invalid_urns(self):
        with self.subTest("None"):
            ...
            error = get_validation_errors(response, "aanvraag_zaak")
            self.assertIsNotNone(error)
        ...
        with self.subTest("string"):
            ...
            error = get_validation_errors(response, "aanvraag_zaak_urn")
            self.assertIsNotNone(error)
    ...
    def test_invalid_urls(self):
        ...
        with self.subTest("string"):
            ...
            error = get_validation_errors(response, "aanvraag_zaak_url")
            self.assertIsNotNone(error)
